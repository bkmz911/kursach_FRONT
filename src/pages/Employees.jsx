  ...
  return (
    <div className="fade-in">
      <div className="page-header">
        <div>
          ...
          <p style={{ "padding-top": "10px", "padding-bottom": "10px" }}>
            {loading ? "Загрузка…" : `${employees.length} из ${total} записей`}
          </p>
        </div>
        <button
          className="btn btn-primary"
          onClick={() => navigate("employee-form", null)}
        >
          ＋ &nbsp;Добавить
        </button>
      </div>
      ...
      <div className="table-card">
        <div className="table-toolbar">
          ...
          >
            ...
            >
              ...
              {["ИТ-отдел", "HR-отдел", "Финансы", "Маркетинг", "Операции"].map(
                (d) => (
        ...
        {error && (
          <div style={{ padding: 24, color: "var(--accent)", fontSize: 14 }}>
            Ошибка: {error}
          </div>
        )}
            ...
            <tbody>
              {employees.map((emp) => (
                <tr key={emp.id}>
                  <td>
                    <div className="employee-cell">
                      <div
                        ...
                        style={{
                          background: avatarColor(emp.id) + "22",
                  ...
                  <td>
                    <span
                      className={`badge ${DEPT_CLASSES[emp.department] || ""}`}
                    >
                      {emp.department}
                    </span>
                  </td>
                  ...
                  <td>
                    <div className="action-btns">
                      <button
                        className="icon-btn"
                        title="Редактировать"
                        onClick={() => navigate("employee-form", emp)}
                      >
                        ✏️
                      </button>
                      <button
